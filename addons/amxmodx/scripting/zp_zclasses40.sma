...
const Float:zclass1_knockback = 1.1

// Raptor Zombie Attributes
new const zclass2_name[] = { "Raptor Zombie" }
new const zclass2_info[] = { "Speed++ Knockback++" }
...
new const zclass5_info[] = { "Knockback+ Leech++" }
...
const zclass5_infecthp = 500 // extra hp for infections
